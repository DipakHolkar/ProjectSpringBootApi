...
const MyUpdateInsti = () => {
  ...
  const { instituteName, address, emailId,contactNum,authorizationStatus  } = institute;
  ...
  const onSubmit = async e => {
    e.preventDefault();
    await axios.put(`http://localhost:8080/updateauthosize/${institute_id}`, institute);
    history.push("/adminhome/institute");
  };
      ...
      <form onSubmit={e => onSubmit(e)}>
        ...
        <div className="form-group">
          ...
          {/* <input
            type="text"
            className="form-control form-control-lg"
            placeholder="Enter Authorization status"
            name="authorizationStatus"
            value={authorizationStatus}
            onChange={e => onInputChange(e)}
          /> */}
<select  name="authorizationStatus" onChange={e => onInputChange(e)} className="form-control form-control-lg">
