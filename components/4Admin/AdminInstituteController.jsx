...
const AdminInstituteController = () => {
          ...
          {institute.map((institute, index) => ( 
              ...
              <td> {/* <Link class="btn btn-primary mr-2" to={`/institute/${institute.institute_id}`}>
                  ...
                  <Link
                    ...
                    to={`/updatebyinstitute/${institute.user.user_id}`}
                  >
                    update
                  </Link>
                   ...
                   {/* <Link
                    ...
                    onClick={() => deleteInstitute(institute.user.user_id)}
                  >
                    Delete
                  </Link>  */}
                </td>
...
export default AdminInstituteController;